...
// ส่วนบันทึกชื่อเรียก (แก้ไขเฉพาะชื่อเล่น)
...
<body class="container mt-4">
    ...
    <div class="card mb-4 border-primary shadow-sm">
        ...
        <div class="card-body">
            <form method="post" class="row g-2 align-items-end">
                <div class="col-md-3"><input type="text" name="new_u" class="form-control" placeholder="Username" required></div>
                <div class="col-md-3"><input type="text" name="new_rn" class="form-control" placeholder="ชื่อที่แสดง (เช่น พี่สมชาย)"></div>
                <div class="col-md-3"><input type="text" name="new_p" class="form-control" placeholder="Password" required></div>
                <div class="col-md-2">
    ...
    <div class="card shadow-sm"><div class="card-body">
        <table class="table table-bordered align-middle text-center">
            <thead class="table-dark"><tr><th>Username</th><th>ชื่อที่แสดง</th><th>Role</th><th>Password</th><th>ลบ</th></tr></thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php if($row['role']!='admin'): ?>
                            <a href="users.php?delete_id=<?php echo $row['id']; ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('ยืนยันลบ?');">🗑️</a>
                        <?php endif; ?>
                    </td>
                </tr>
                <?php endwhile; ?>
